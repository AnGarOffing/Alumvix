...
namespace Alumvix.Controller.Gasto
{
    internal class DetalleGastoController
    {
        ...
        public DetalleGastoController(DetalleGastoView detalleGastoVista) 
        {
            ...
            detalleGastoView.pnlSuperiorDetalleGastoView.MouseDown += new MouseEventHandler(PermitirMovimientoDeForm);
        }

        private void PermitirMovimientoDeForm(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
            SendMessage(detalleGastoView.Handle, 0x112, 0xf012, 0);
        }
