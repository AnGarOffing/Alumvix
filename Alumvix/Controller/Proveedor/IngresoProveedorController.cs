...
namespace Alumvix.Controller.Proveedor
{
    internal class IngresoProveedorController
    {
        ...
        public IngresoProveedorController(IngresoProveedorView ingresoProveedorVista)
        {
            ...
            ingresoProveedorView.pnlSuperiorIngresoProveedorView.MouseDown += new MouseEventHandler(PermitirMovimientoDeForm);
        }

        private void PermitirMovimientoDeForm(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
            SendMessage(ingresoProveedorView.Handle, 0x112, 0xf012, 0);
        }
